...
class Cms extends MY_Controller {
	...
	function dashboard(){
		...
		$data['total_unverified'] = $get_unverified <> false ? $get_unverified->num_rows() : "0";
		$get_verified = $this->Teacher_m->get_verified();
		$data['total_verified'] = $get_verified <> false ? $get_verified->num_rows() : "0";
		
		$data['software_updates'] = $this->Software_m->get_software_updates(array('software_name' => 'tutordoors.com'));
		$data['software_updates_android_td_id'] = $this->Software_m->get_software_updates(array('software_name' => 'android-td-id'));
