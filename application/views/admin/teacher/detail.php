							...
							<div class="col-md-12">
								<table class="table table-striped">
									<tr>
		                                ...
		                                <th><?php echo $this->lang->line('document_college_certificate') ?></th>
		                                <th><?php echo $this->lang->line('document_transcript') ?></th>
									</tr>
				...
				<div class="box box-danger collapsed-box">
		          	...
		          	<div class="box-body">
		          		<table class="table table-bordered table-striped">
							...
							?>
							<tr>
								<td><?php echo $course_info->row()->program_name ?></td>
								<td><?php echo $course_info->row()->course_name ?></td>
								<td><?php echo $days?></td>
