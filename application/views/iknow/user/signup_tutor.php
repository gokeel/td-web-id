    ...
    <div class="contant">
    	<div class="container">
        <div class="buttons">
          <!-- <a href="<?php echo base_url('auth/social_media/facebook/tutor') ?>"><button class="btn1 login-btn"><i class="fa fa-facebook"></i>Sign up with Facebook</button></a> -->
            
          <a href="<?php echo base_url('auth/social_media/google/tutor') ?>"><button class="btn2 login-btn"><i class="fa fa-google-plus"></i>Sign up with Google</button></a>
          
          <!-- <a href="<?php echo base_url('auth/social_media/linkedin/tutor') ?>"><button class="btn4 login-btn"><i class="fa fa-linkedin"></i>Sign up with Linkedin</button></a> -->
