...
<!-- CUSTOM CSS -->
<link href="<?php echo IKNOW_DIR;?>/css/style.css" rel="stylesheet" type="text/css" media="screen">
    ...
    <div class="top-bar">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-8 col-xs-8 col">
          ...
          <div class="value"><i class="fa fa-phone"></i> <?php echo $opt_phone->parameter_value .' / '.$opt_mobile->parameter_value ?></div>
        </div>
