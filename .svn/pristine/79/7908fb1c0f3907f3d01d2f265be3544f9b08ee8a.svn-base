  ...
  <section class="boxku">
		<div class="row">
        	...
        	<div class="box-body no-padding">
						<!-- form start -->
						<form role="form" id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url().($title=="add" ? 'cms/add_page' : 'cms/update_page?id='.$this->input->get('id'));?>">
								...
								<div class="row">
									<div class="col-sm-8">
										<div class="form-group">
											...
											<input type="text" class="form-control input-sm" id="title" name="title" placeholder="" value="<?php if($title=='edit') echo $page_data->title;?>" onkeyup="set_url(this.value);" required>
										</div><!-- ./form-group -->
										<div class="form-group">
											<label for="title">Niece URL</label>
											<input type="text" class="form-control input-sm" id="url" name="url" placeholder="" value="<?php if($title=='edit') echo $page_data->url;?>" readonly>
										</div><!-- ./form-group -->
										<div class="form-group">
											<label for="content">Page Content</label>
											<textarea class="form-control" id="content-editor" name="content" rows="10" cols="80"> <?php if($title=='edit') echo $page_data->content;?></textarea>
										</div><!-- ./form-group -->
									</div><!-- ./col -->
									<div class="col-sm-4">
									</div><!-- ./col -->
